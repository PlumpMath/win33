...
//  /// </summary>
//  /// <example>
//  ///    DropboxContextMenu scm = new DropboxContextMenu();
//  ///    FileInfo[] files = new FileInfo[1];
//  ///    files[0] = new FileInfo(@"c:\windows\notepad.exe");
//  ///    scm.ShowContextMenu(this.Handle, files, Cursor.Position);
//  /// </example>
//  public class DropboxContextMenu
//  {
//    #region Constructor
//    /// <summary>Default constructor</summary>
//    public DropboxContextMenu()
//    {
//    }
//    #endregion
...
//    #region CopyPublicLink

//    public void CopyPublicLink(string fileName)
//    {
//      FileInfo[] files = new FileInfo[1] { new FileInfo(fileName) };
//      CopyPublicLink(files);
//    }

//    private void CopyPublicLink(FileInfo[] arrFI)
//    {
...
//        FindAndCallCopyPublicLink(pMenu);
...
//    private void FindAndCallCopyPublicLink(IntPtr pMenu)
//    {
//      int count = GetMenuItemCount(pMenu);

//      for (int index = 0; index < count; index++)
//      {
//        string text = string.Empty.PadLeft(256);

//        MENUITEMINFO itemInfo = new MENUITEMINFO();

//        itemInfo.cbSize = cbMenuItemInfo;
//        itemInfo.dwTypeData = text;
//        itemInfo.cch = text.Length;
//        itemInfo.fMask = MIIM.SUBMENU | MIIM.TYPE | MIIM.DATA | MIIM.ID;
//        itemInfo.fType = 0;
//        itemInfo.fState = 0;
//        itemInfo.wID = 0;
//        itemInfo.hSubMenu = IntPtr.Zero;
//        itemInfo.hbmpChecked = IntPtr.Zero;
//        itemInfo.hbmpUnchecked = IntPtr.Zero;
//        itemInfo.dwItemData = IntPtr.Zero;
//        itemInfo.hbmpItem = IntPtr.Zero;

//        GetMenuItemInfoW(pMenu, (uint)index, true, ref itemInfo);

//        if (itemInfo.dwTypeData == "&Dropbox")
//        {
//          //enter to submenu
//          FindAndCallCopyPublicLink(itemInfo.hSubMenu);
//          break;
//        }

//        if (itemInfo.dwTypeData == "Copy public link")
//        {
//          InvokeCommand(_oContextMenu, itemInfo.wID, null, new Point()/*Control.MousePosition*/);
//          break;
//        }

//        Trace.WriteLine("## " + itemInfo.dwTypeData);
//      }
//    }
...
//    private static extern bool GetMenuItemInfoW(IntPtr hMenu, uint uItem, bool fByPosition, ref MENUITEMINFO lpmii);
